    ...
    <main className="flex min-h-screen flex-col items-center p-0">
      <div className="flex flex-col">
        <div className="relative flex place-items-center flex-col mt-10">
          <h1 className="lg:text-6xl sm:text-3xl">Hunter Coder</h1>
          <p className="lg:text-2xl sm:text-lg">A blog for Code Hunters</p>
          <div className="mt-5">
            <img
              className="rounded-xl lg:w-80 sm:w-48 lg:h-80 sm:h-48"
              src="/homeimg.jpg"
              alt="hunting coder"
            />
          </div>
        ...
        <hr />
        <div className="flex lg:flex-row sm:flex-col mt-6 text-start lg:mb-0 lg:grid-cols-2 lg:text-left">
          <Link
            href="/blogs"
